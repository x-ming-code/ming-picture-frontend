<template>
  <a-modal
    ...
    @cancel="closeModal"
  >
    <p style="font-size: 12px; color: #8c8c8c;">注意：图片不低于512×512像素且不超过4096×4096像素</p>
    <a-row gutter="16">
      <a-col span="12">
        <h4>原始图片</h4>
    ...
    <p style="font-size: 12px; color: black;">每个用户免费扩图额度为10次</p>
...
//剩余的免费额度
const remainingFreeQuota = ref<number>(null)
/**
 * 创建任务
 */
const createTask = async () => {
  ...
  if (res.data.code === 0 && res.data.data) {
    ...
    //remainingFreeQuota.value = res.data.data.remainingFreeQuota
